...
- типы и интерфейсы все (по возможности) перенеси в shared - 1 источник типов
- проверь что в компонентах на фронте соблидаются правила из uno.config.ts они внизу в комментариях, если нет исправь

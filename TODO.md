...
- давай реализуем большую фичу - Архив карточек/воркспейсов карточка отправляется в архив из модального окна редактирования воркспейс из списка (там где в избранное добавляем) добавь иконку к карточке воркспейса для архивации. Для Архива есть отдельная вкладка (vue) там 2 радиокнопки архивные карточки и воркспейсы (архивные карточки удаляются вместе с воркспейсом и колонками соответственно, это на всякий прописал чтобы не было такого что некуда восстановить карточку) В общем как обычное поведение

...
- Кнопка скопировать текст в модалке просмотра заметки (текста)
- добавить дату выполнения + вью в хедере 2
- Markdown в заметках
...
- починить для сафари и яндекс браузера (хранить токен в локал сторидж временно, хоть и небезопасно)

# Микрофиксы

- подумать про шорткат разные браузеры + мак
